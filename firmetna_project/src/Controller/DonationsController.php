...
class DonationsController extends AbstractController
{
    ...
    public function index(Request $request, SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', 'Votre offre a été publiée avec succès. Merci pour votre don !');
    ...
    public function produit(string $type): Response
    {
        $infos = [
            'legumes' => [
                ...
                'description' => 'Tomates, carottes, courgettes, laitue et autres légumes frais du terroir. Cultivés localement, ils sont idéaux pour une alimentation saine et une agriculture de proximité.',
                'details' => 'Nos donateurs proposent des légumes de saison, souvent issus de surplus ou de récoltes solidaires. Les quantités varient selon les dons (kilos, cageots). Contactez le donateur via la liste des offres pour convenir d\'un retrait.',
            ...
            'fruits' => [
                ...
                'details' => 'Fruits frais ou en surplus, proposés en kg ou en caisses. Les variétés et quantités dépendent des dons. Consultez les offres des donateurs ci-dessous et faites votre demande.',
            ...
            'engrais' => [
                ...
                'description' => 'Engrais organique, compost et amendements pour les cultures. Des dons de coopératives ou d\'agriculteurs pour favoriser une agriculture durable.',
                'details' => 'Sacs d\'engrais organique, compost ou autres intrants proposés par des donateurs. Quantités et types variables. Faites une demande via le bouton ci-dessous pour être mis en relation avec le donateur.',
                'image' => 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?auto=format&fit=crop&q=80&w=1920',
                'icon' => 'fas fa-vial',
            ],
            'semences' => [
                'titre' => 'Semences',
                'sous_titre' => 'Disponible semences blé et orge maintenant',
                'description' => 'Semences de blé, orge, légumes et cultures diverses. Des dons pour aider les agriculteurs à ensemencer leurs parcelles.',
                'details' => 'Sachets ou quantités de semences (céréales, maraîchage) proposés par des donateurs. Idéal pour démarrer une culture ou compléter un stock. Consultez les offres et demandez via le formulaire des dons.',
    ...
    public function demander(Request $request, Offre $offre): Response
    {
        ...
        if ($this->demandeRepository->userADejaDemande($this->getUser(), $offre)) {
            $this->addFlash('info', 'Vous avez déjà demandé cette offre.');
            return $this->redirectToRoute('app_donations');
        }
        ...
        $this->addFlash('success', 'Votre demande a été enregistrée. Le donateur vous contactera.');
        return $this->redirectToRoute('app_donations');
    }
}
