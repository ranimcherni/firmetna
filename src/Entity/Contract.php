...
class Contract
{
    ...
    #[ORM\Column(type: Types::DATE_MUTABLE, nullable: true)]
    #[Assert\GreaterThan(propertyPath: 'dateDebutContract', message: 'La date de fin doit être postérieure à la date de début.')]
    private ?\DateTimeInterface $dateFinContract = null;

    #[ORM\Column(type: Types::DATE_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $dateDebutContract = null;

    #[ORM\Column(length: 50, nullable: true)]
    #[Assert\Choice(
        choices: ['Actif', 'Suspendu', 'Terminé', 'Annulé'],
    ...
    public function setDateDebutContract(?\DateTimeInterface $dateDebutContract): static
    {
    ...
    public function setDateFinContract(?\DateTimeInterface $dateFinContract): static
    {
